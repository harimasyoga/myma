				...
				<table style="width:100%" cellspacing="5">
					...
					<tr>
						...
						<td>
							...
							<input class="form-control" type="text" name="nm_peg" id="nm_peg" autocomplete="off">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input class="form-control" type="text" name="jabatan" id="jabatan" autocomplete="off">
						</td>
					</tr>
				</table>
			</div>
...
<script type="text/javascript">
	...
	function load_data() 
	{
		...
		tabel = $('#datatable').DataTable({
			...
			"paging": true,
			"ajax": {
				"url": '<?php echo base_url(); ?>Master/load_data/pegawai',
				"type": "POST",
			},
			responsive: false,
			"pageLength": 25,
	...
	function tampil_edit(id, act) {
		...
		.done(function(json) {
			data = JSON.parse(json)
			// console.log(data)
			$("#id_peg").val(data.id_peg);
			$("#nm_peg").val(data.nm_peg);
			$("#nip").val(data.nip);
