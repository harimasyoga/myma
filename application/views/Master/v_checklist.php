...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="card row-list">
			...
			<div class="card-body">
					<button type="button" style="font-family:Cambria;" class="tambah_data btn  btn-info pull-right btn-sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;<b>Tambah Data</button>
					<button type="button" class="btn btn-danger btn-sm" onclick="cetak_lap()"><i class="fa fa-print"></i> <b>Laporan</b></button>
				...
				<table id="datatable" class="table table-bordered table-striped" width="100%">
					<thead class="color-tabel">
						<tr>
							...
							<th style="text-align: center;width:50%">No Perkara</th>
							<th style="text-align: center;width:50%">PP</th>
							<th style="text-align: center;width:50%">Ada ?</th>
...
<script type="text/javascript">
	...
	function load_data() {
		...
		tabel = $('#datatable').DataTable({
			...
			"paging": true,
			"ajax": {
				"url": '<?php echo base_url(); ?>Master/load_data/checklist',
				"type": "POST",
			},
			"aLengthMenu": [
				[10, 15, 20, 25, -1],
	...
	function cetak_lap(ctk)
	{		
		var url    = "<?php echo base_url('Master/cetak_check'); ?>";
